...
export const DATA = {
  ...
  work: [
    {
      ...
      description:
        "Promoted to full-stack on the same global car leasing platform:",
      tasks: [
        "Implementing business logic and API improvements using Python/Django.",
        "Developing full-stack features across React and Django applications.",
        "Integrating Apollo GraphQL and improving data flow and caching.",
        "Collaborating in code reviews, Agile ceremonies, and technical planning.",
        "Maintaining code quality following SOLID, KISS, and DRY principles.",
      ],
    },
    {
      company: "Voyager Global Mobility",
      ...
      tasks: [
        "Built scalable and reusable React components for responsive UI.",
        "Migrated legacy class components to functional components and hooks.",
        "Performance optimization with useMemo, useCallback, and pagination.",
        "Improved accessibility and UI responsiveness using CSS and Reactstrap.",
        "Wrote unit tests to maintain 80% coverage.",
      ],
    },
    {
      company: "MediSprout",
    ...
    },
    {
      ...
      description:
        "Managed client orders and ensured timely fulfillment by coordinating between customers and internal teams.",
      tasks: [
        "Received and processed customer orders, ensuring accuracy and completeness.",
        "Followed up on order status and communicated updates to clients.",
        "Coordinated with internal teams to meet delivery timelines.",
        "Maintained positive client relationships through clear and responsive communication.",
      ],
    },
  ],
  education: [
  ...
  projects: [
    ...
    {
      title: "Lingora — Language Learning",
      href: "https://lingorav1-production.up.railway.app/",
      dates: "2026 - Present",
      active: true,
      description:
        "A Duolingo-style language learning platform that is native-language-aware: a Spanish speaker learning German gets Spanish hints and answer options, not English. React 19 + TypeScript frontend with a Django 5 / DRF / PostgreSQL backend, token and Google OAuth auth, XP and streak progression, and a four-locale UI. Try it without signing up — the welcome flow runs real exercises. In active development.",
      technologies: [
        "React 19",
        "TypeScript",
        "Vite",
